...
<div id="qsn_content_div_<?php echo $this->qsn_info['qsn_id'].$this->qsn_info['qsn_sub_id']?>" qsn_id="<?php echo $this->qsn_info['qsn_id']?>" qsn_sub_id="<?php echo $this->qsn_info['qsn_sub_id']?>" name="qsn_content_div"  class="qt" style=" <?php if(!$this->options['is_display']){?>display: none;<?php }?>">
	...
	<input type="hidden" id="qsn_option_count_<?php echo $this->qsn_info['qsn_id'].$this->qsn_info['qsn_sub_id']?>" name="qsn_option_count" value="<?php echo $this->qsn_info['qsn_option_count']?>"  />
	<div class="qt_main">
		<div class="inner">
			<div class="col_left">
				...
				<h2 class="label_btn">
				<a class="icon_label_off" id="exam_mark_icon_<?php echo $this->qsn_info['qsn_id'].$this->qsn_info['qsn_sub_id']?>" title="<?php echo $this->qsn_info['qsn_point'];?><?php echo L::getText('进行标记', array('file'=>__FILE__, 'line'=>__LINE__))?>" href="javascript:void(0)" onclick="examMarkQsn('<?php echo $this->qsn_info['qsn_id'].$this->qsn_info['qsn_sub_id']?>');return false;" ></a>
			</h2>
				<?php }?>
			...
			<div class="col_right_01">
				<!-- // 试题内容 -->
				<div class="content">
					<div class="qt_title" id="user_answer_div_<?php echo $this->qsn_info['qsn_id'].$this->qsn_info['qsn_sub_id']?>">
	...
	<div class="qt_result" name="qsn_answer_info_div">
		<div class="inner">
			...
			<dl class="answer_st">
				...
				<dd>
						<?php foreach( $this->qsn_info['qsn_answer'] as $qa){?>
						<b><?php echo $qa['qsn_item_id'] ?>.</b><?php echo $qa['qsn_answer'] ?>&nbsp;&nbsp;
						<?php }?>
					</dd>
			</dl>
			<?php }?>
...
<div class="qt_content ~none" id="qsn_content_div_<?php echo $this->qsn_info['qsn_id'].$this->qsn_info['qsn_sub_id']?>" qsn_id="<?php echo $this->qsn_info['qsn_id']?>" qsn_sub_id="<?php echo $this->qsn_info['qsn_sub_id']?>" name="qsn_content_div" style="">
	...
	<div class="qt_title qt_title_sub1">
