...
<div id="qsn_content_div_<?php echo $this->qsn_info['qsn_id'].$this->qsn_info['qsn_sub_id']?>" qsn_id="<?php echo $this->qsn_info['qsn_id']?>" qsn_sub_id="<?php echo $this->qsn_info['qsn_sub_id']?>" name="qsn_content_div" style="<?php if(!$this->options['is_display']){?>display: none;<?php }?>">
			...
			<div class="col_right_01" style="width:85%">
				...
				<div class="content">
					...
					<div class="qt_content">
						<?php foreach($this->qsn_info['qsn_option'] as $qo){?>
						
						<div>
							<div style="float: left;">
							<?php if($this->qsn_info['qsn_type'] == '010101'){?>
							<input class="radiobox"  name="exam_qsn_answer_<?php echo $this->qsn_info['qsn_id'].$this->qsn_info['qsn_sub_id']?>" id="option_<?php echo $this->qsn_info['qsn_id'].$this->qsn_info['qsn_sub_id'].$qo['qsn_item_id'].$qo['qsn_item_sub_id']?>" qsn_item_id="<?php echo $qo['qsn_item_id']?>" qsn_item_sub_id="<?php echo $qo['qsn_item_sub_id']?>" type="radio" value="<?php echo $qo['qsn_item_tag']?>" />
							<?php }elseif ($this->qsn_info['qsn_type'] == '010102'){?>
							<input class="checkbox"  name="exam_qsn_answer_<?php echo $this->qsn_info['qsn_id'].$this->qsn_info['qsn_sub_id']?>" id="option_<?php echo $this->qsn_info['qsn_id'].$this->qsn_info['qsn_sub_id'].$qo['qsn_item_id'].$qo['qsn_item_sub_id']?>" qsn_item_id="<?php echo $qo['qsn_item_id']?>" qsn_item_sub_id="<?php echo $qo['qsn_item_sub_id']?>" type="checkbox" value="<?php echo $qo['qsn_item_tag']?>" />
							<?php }?>
							<?php echo $qo['qsn_item_tag']?>. 
							
							</div>
								<div>
								<div class="" style="float: none;margin-left: 35px;" >
								<?php echo htmlspecialchars_decode($qo['option_content'])?>
								</div>
							</div>
						</div>
						<?php }?>
	...
	<div class="qt_result" name="qsn_answer_info_div">
		<div class="inner">
			...
			<dl class="answer_st">
				...
				<dd><?php foreach ($this->qsn_info['qsn_answer'] as $qa){?>
						<?php echo $qa['qsn_answer']?>&nbsp;&nbsp;
					<?php }?></dd>
			</dl>
			<?php }?>
...
<?php }else{?>
<div class="qt_content ~none" id="qsn_content_div_<?php echo $this->qsn_info['qsn_id'].$this->qsn_info['qsn_sub_id']?>" qsn_id="<?php echo $this->qsn_info['qsn_id']?>" qsn_sub_id="<?php echo $this->qsn_info['qsn_sub_id']?>" name="qsn_content_div" style=" ">
	<input type="hidden" id="qsn_content_absposition_<?php echo $this->qsn_info['qsn_id'].$this->qsn_info['qsn_sub_id']?>" name="qsn_content_absposition" value="<?php echo $this->qsn_info['qsn_absposition']?>"  />
	<input type="hidden" id="exam_qsn_type_<?php echo $this->qsn_info['qsn_id'].$this->qsn_info['qsn_sub_id']?>" name="exam_qsn_type" value="<?php echo $this->qsn_info['qsn_type']?>"  />
	<input type="hidden" id="exam_qsn_type_pos_<?php echo $this->qsn_info['qsn_id'].$this->qsn_info['qsn_sub_id']?>" name="exam_qsn_type_pos" value="<?php echo $this->qsn_info['qsn_type_position']?>"  />
	<input type="hidden" id="exam_qsn_pos_<?php echo $this->qsn_info['qsn_id'].$this->qsn_info['qsn_sub_id']?>" name="exam_qsn_pos" value="<?php echo $this->qsn_info['qsn_position']?>"  />
