...
$this->printHead(
    array(
        'title' => array('title'=>'学习计划-学习计划监控', 'file'=>__FILE__, 'line'=>__LINE__)
        ,'css'=>array(
            '/admin/index/backhead.css',
			'/admin/plan/plan.css'
        )
        ,'js'=>array(
            '/admin/plan/plan/learningStatistics.js',
            '/admin/manyTrees.js'
        )
    )
);
?>
<!-- 2012 11 26 update block_5 > block_2 -->
<div class="box block_2"><!-- // block_## 序号对应全局的颜色定义 -->
    <div class="box_inner">
        ...
        <div class="panel_1 con_search">
            <div class="title"><span><?php echo L::getText('计划搜索', array('file'=>__FILE__, 'line'=>__LINE__)); ?></span></div>
            <div class="content">
