...
$this->printHead(
    array(
        'title' => array('title'=>'考试审批', 'file'=>__FILE__, 'line'=>__LINE__)
...
<div class="box block_6"><!-- // block_## 序号对应全局的颜色定义 -->
	<div class="box_inner">
		...
		<div class="panel_1 con_search" id="verify_search_param_div">
			<div class="title"><span><?php echo L::getText('考试', array('file'=>__FILE__, 'line'=>__LINE__))?></span></div>
			<div class="content">
            <!-- 2012 11 21 uptate span to div -->
				...
				<div class="search_item">
					...
					<a href="javascript:void(0)" onclick="verifyExamCategoryTreeShow('exam_category_name','exam_category')" id="exam_category_name" name="exam_category_name" ><?php echo L::getText('请选择考试分类', array('file'=>__FILE__, 'line'=>__LINE__))?></a>
					<input type="hidden" value="" name="exam_category" id="exam_category" />	
				</div>
				...
				<div class="button_area_search">
					<div class="inner_box">
						<a  href="javascript:void(0)" onclick="verifySearchVerifyList('exam')"  class="btn2" ><?php echo L::getText('搜索', array('file'=>__FILE__, 'line'=>__LINE__))?></a>
