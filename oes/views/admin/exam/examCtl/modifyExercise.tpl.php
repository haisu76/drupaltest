...
$this->printHead(
                array(
                    'title' => array('title'=>'修改练习', 'file'=>__FILE__, 'line'=>__LINE__)
...
<div class="box block_1"><!-- // block_## 序号对应全局的颜色定义 -->
	<div class="box_inner">
		...
		<!-- 查询页面的条件 -->
		<form id="manage_exercise_form" name="manage_exercise_form" action="exerciseCtl.php?a=index" method="post">
		...
		<?php
			$exam_exe_str = L::getText('练习', array('file'=>__FILE__, 'line'=>__LINE__));
		...
		<div class="button_area_search">
			...
			<div class="center">
				...
				<a href="javascript:void(0)" onclick="$('#manage_exercise_form').submit();return false;" class="btn" ><?php echo L::getText('关闭', array('file'=>__FILE__, 'line'=>__LINE__))?></a>
			</div>
