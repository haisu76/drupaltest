...
$this->printHead(
                array(
                    'title' => array('title'=>'考生监控', 'file'=>__FILE__, 'line'=>__LINE__)
			...
			<div class="content" id="exam_search_param_div">
				<div class="search">
					...
					<div class="search_item">
						...
						<input class="input3 ~auto_width" type="text" name="username" id="username" />
						</div>
					<div class="search_item">
					...
					<div class="search_item">
						...
						<a href="javascript:void(0)" onclick="examGroupTreeShow('group_name','group_id',false)" id="group_name" name="group_name"><?php echo L::getText('请选择用户组', array('file'=>__FILE__, 'line'=>__LINE__))?></a>
				...
				<div class="button_area_search">
					<div class="inner_box btn_box">
						<a href="javascript:void(0)" onclick="examSearchUserMonitorList()" class="btn2" ><?php echo L::getText('搜索', array('file'=>__FILE__, 'line'=>__LINE__))?></a>
