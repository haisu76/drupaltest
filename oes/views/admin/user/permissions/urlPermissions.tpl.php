...
$this->printHead(
    array(
        ...
        ,'js' => array(
            '/admin/user/permissions/urlPermissions.js'
        )
    )
);
?>
<div class="box block_11"><!-- // block_## 序号对应全局的颜色定义 -->
    <div class="box_inner"> 
        ...
        <div class="panel_1 con_search">
            ...
            <div class="content">
                <form onsubmit="urlPermissionsObj.searchSubmit(); return false;" id="searchForm">
                    <div class="search">
                        ...
                        <div class="search_item">
                            <h1><?php echo L::getText('包含路径', array('file'=>__FILE__, 'line'=>__LINE__));?></h1>
                            <input type="text" style="width:250px;" id="path" class="input4 ~auto_width">
                        </div>
                    </div>
                    
                    <!-- // 高级搜索 -->
                    <div style="float:left;width:100%;" class="button_area_search">
                        <div class="inner_box"> <a onclick="urlPermissionsObj.searchSubmit(); return false;" class="btn2" href="#"><?php echo L::getText('搜索', array('file'=>__FILE__, 'line'=>__LINE__));?></a> <a onclick="document.getElementById('searchForm').reset(); return false;" class="btn2" href="#"><?php echo L::getText('重置', array('file'=>__FILE__, 'line'=>__LINE__));?></a> </div>
                    </div>
        ...
        <div class="panel_1 con_table">
            ...
            <div class="content">
                <?php echo $this->urlPermissionsPageTable; ?>
            </div>
        </div>
