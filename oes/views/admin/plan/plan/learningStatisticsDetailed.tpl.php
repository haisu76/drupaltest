...
$this->printHead(
    array(
        ...
        ,'js'=>array(
            '/admin/plan/plan/learningStatisticsDetailed.js',
            '/admin/manyTrees.js'
        )
    )
);
...
<div class="box block_5"><!-- // block_## 序号对应全局的颜色定义 -->
    <div class="box_inner">
        <!-- // 搜索过滤 -->
        <div class="panel_1 con_search" style="float:left;">
            ...
            <div class="content">
                <form id="searchForm" onSubmit="learningStatisticsDetailed.searchSubmit(); return false;">
                    <div class="search" style="float:left; margin-bottom:5px;">
                        <div class="search_item" style="margin-left:0px;">
                    ...
                    <!-- // 高级搜索 -->
                    <div class="button_area_search" style="float:left;width:100%; margin-bottom:10px; ">
                        <div class="inner_box">
        ...
        <div class="panel_1 con_table">
            <div class="title" style="float:left;"><span><?php echo L::getText('用户列表', array('file'=>__FILE__, 'line'=>__LINE__)); ?></span><br/></div>
            <div class="clear"></div>
